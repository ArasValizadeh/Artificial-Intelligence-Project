...
checkpoint = torch.load("/Users/arasvalizadeh/Desktop/check project/Artificial-Intelligence-Project/phase2/best_model_with_norm3.pth", map_location=torch.device("cpu"))
